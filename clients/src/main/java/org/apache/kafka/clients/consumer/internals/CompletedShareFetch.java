...
/**
 * {@link CompletedShareFetch} represents a {@link RecordBatch batch} of {@link Record records} that was returned from the
 * broker via a {@link ShareFetchRequest}. It contains logic to maintain state between calls to {@link #fetchRecords(int)}.
 *
 * @param <K> Record key type
 * @param <V> Record value type
 */
class CompletedShareFetch<K, V> {
   ...
   */
  ConsumerRecord<K, V> parseRecord(TopicIdPartition partition,
