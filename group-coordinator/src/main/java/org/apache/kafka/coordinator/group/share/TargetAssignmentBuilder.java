 ...
 * it yields new member assignments as a map.
 *
 */
public class TargetAssignmentBuilder {
   ...
   */
  private Map<String, ShareGroupMember> members = Collections.emptyMap();
   ...
   */
  private final Map<String, ShareGroupMember> updatedMembers = new HashMap<>();
   ...
   *
   * @param members   The existing members in the share group.
   * @return This object.
   */
  ...
  public TargetAssignmentResult build() throws PartitionAssignorException {
    ...
    // Compute delta from previous to new target assignment.
